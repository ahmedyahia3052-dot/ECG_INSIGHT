...
- Name: live-monitor-layout-hotfix.spec.ts >> Live Monitor Layout Hotfix @live-monitor-layout @enterprise >> sidebar layout is stable at 1366x768
- Location: tests\e2e\live-monitor-layout-hotfix.spec.ts:34:9

# Error details

```
Error: ECG case API create failed: {"code":"INTERNAL_SERVER_ERROR","message":"Unexpected server error.","requestId":"bc518eef-3908-43cd-8318-701db8e673ad"}
```
