...
- Name: sprint49-live-monitor-hmi.spec.ts >> Sprint 49 Hospital ECG Monitor HMI @sprint49 @enterprise >> professional HMI status bar shows patient identity and telemetry
- Location: tests\e2e\sprint49-live-monitor-hmi.spec.ts:29:7

# Error details

```
Error: ECG case API create failed: {"code":"INTERNAL_SERVER_ERROR","message":"Unexpected server error.","requestId":"90d1eaa2-7fea-43cf-a7b0-8ed649ecc0d9"}
```
