...
for (const marker of ["retrieveClinicalContext", "shouldRetrieveClinicalContext", "shouldRetrieveKnowledge", "retrieveConversationMemory", "classifyWithPipeline", "runIntentPipeline", "classifyMedicalIntent", "composeConversationalResponse", "./intent-manager", "./intent-pipeline", "./intent-classifier", "./tool-router", "LEGAL_DISCLAIMER", "automaticConversationTitle", "lastMessagePreview", "analyzeUploadedAttachment", "detectAttachmentDocumentType", "readBestEffortOcrText", "/chat/stream", "writeSse", "streamAssistantContent", "export.txt", "auditCopilotError", "copilotUsageEvent"]) {
