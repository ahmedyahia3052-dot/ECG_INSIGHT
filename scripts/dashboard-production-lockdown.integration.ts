...
for (const marker of ["retrieveClinicalContext", "shouldRetrieveClinicalContext", "shouldRetrieveKnowledge", "retrieveConversationMemory", "runAiBrainV3", "ResponseComposer", "DecisionEngine", "ClinicalPlanner", "MemoryManager", "classifyWithPipeline", "runIntentPipeline", "classifyMedicalIntent", "composeConversationalResponse", "./intent-manager", "./intent-pipeline", "./intent-classifier", "./tool-router", "./brain", "LEGAL_DISCLAIMER", "automaticConversationTitle", "lastMessagePreview", "analyzeUploadedAttachment", "detectAttachmentDocumentType", "readBestEffortOcrText", "/chat/stream", "writeSse", "streamAssistantContent", "export.txt", "auditCopilotError", "copilotUsageEvent"]) {
