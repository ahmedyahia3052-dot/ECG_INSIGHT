  ...
  const ecgJson = analyzeAttachmentStructured({
    ...
    medicalAnalysis: {
      normalizedContext: {
        ...
        extractedTextPreview: "sinus rhythm rate 72 pr 160 qrs 90 qtc 420",
        findings: ["sinus rhythm"],
        kind: "ecg",
        measurements: [],
        metadata: { mimeType: "image/png", originalName: "tracing.png", patientIdentifiers: [], sizeBytes: 1000 },
        modality: "ecg",
        numericalValues: { heartRateBpm: 72, prIntervalMs: 160, qrsDurationMs: 90, qtcMs: 420 },
        ocrConfidence: 0.8,
        pageReferences: [],
