...
const checks: Array<[string, boolean]> = [
  ...
  ["Hero fill target 90%", imageEngine.includes("ECG_HERO_FILL_TARGET = 0.9")],
  ...
  ["280px minimum sidebar width", read(path.join(VIEWER, "ecgWorkstationVisualTokens.ts")).includes("leftPanelMinWidth: 280")],
