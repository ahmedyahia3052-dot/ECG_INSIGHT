...
async function main() {
  ...
  const checks: Array<[string, boolean]> = [
    ...
    ["crisp image rendering", engine.includes("crisp-edges") || engine.includes("imageRendering") || engine.includes("WebkitFontSmoothing")],
    ...
    ["foundation runtime wiring", foundation.includes("setRenderFps") && foundation.includes("EcgEnterpriseStatusBar")],
