...
import { clickViewControl, ecgViewMode, openEcgMonitor, openMeasurementsTab, paletteButton, toolbarButton } from "./utils/ecg-workspace-locators";
...
test.describe("Sprint 14 Clinical Calipers @sprint14", () => {
  ...
  test("toolbar exposes export controls for measurement workspace", async ({ page }) => {
    await openMonitorReady(page, caseId);
