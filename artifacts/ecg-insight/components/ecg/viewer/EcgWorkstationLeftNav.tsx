...
const styles = StyleSheet.create({
  ...
  shell: { backgroundColor: "#06111F", borderColor: medicalTheme.border, borderRadius: ECG_WORKSTATION_VISUAL.panelBorderRadius, borderWidth: 1, flex: 1, minHeight: 0, overflow: "hidden" },
});
