...
const NAV_ITEMS: NavItem[] = [
  ...
  { icon: "sliders", label: "Notification Preferences", route: "/(tabs)/notification-preferences", section: "Workspace" },
  ...
  { icon: "dollar-sign", label: "Financial Center", route: "/(tabs)/financial-center", adminOnly: true, section: "Administration" },
  { icon: "send", label: "Notification Console", route: "/(tabs)/notification-console", adminOnly: true, section: "Administration" },
