...
import { buildEnterpriseClinicalReportSections } from "./clinical-report-html-sections";
...
export async function buildReportHtml(reportIdOrReport: string | ClinicalReport, baseUrl = "") {
  ...
  const enterpriseSections = await buildEnterpriseClinicalReportSections(report);
  return `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
