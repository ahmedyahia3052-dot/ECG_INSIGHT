...
export const patientBodySchema = z.object({
  ...
  gender: z.enum(["male", "female", "child_male", "child_female", "other", "unknown"]).default("unknown"),
...
export const patientListSchema = z.object({
  ...
  gender: z.enum(["male", "female", "child_male", "child_female", "other", "unknown"]).optional(),
